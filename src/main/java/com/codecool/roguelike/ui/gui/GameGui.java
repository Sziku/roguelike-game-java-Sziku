...
public class GameGui implements GameUI, GameInputReader {
    ...
    public GameGui(int sizeX, int sizeY, Map<Character, TileRenderer> tileRendererMap) {
        gameGuiJFrame = new GameGuiJFrame(this, "Returnal", 33, 33, 1, sizeX, sizeY, tileRendererMap);
    }

    public GameGui(String title, int fieldWidth, int fieldHeight, int spaceBetweenFields, int sizeX, int sizeY, Map<Character, TileRenderer> tileRendererMap) {
