...
class GameGuiJFrame extends JFrame {
    ...
    public GameGuiJFrame(GameGui gameGui, String title, int fieldWidth, int fieldHeight, int spaceBetweenFields, int sizeX, int sizeY, Map<Character, TileRenderer> tileRenderers) {
